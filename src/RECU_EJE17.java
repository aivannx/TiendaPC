...
public class RECU_EJE17 {
	...
	public static void main(String[] args) {
		...
		do {
		iNumero=(int) valida("Introduce un numero: ",-1000,1000,1);
		
		if (iNumero>=1) {
			System.out.println("El numero "+iNumero+" es positivo");
		}
		...
		else System.out.println("El numero "+iNumero+" es negativo");

		}while(iNumero>=1 || iNumero<=-1);
